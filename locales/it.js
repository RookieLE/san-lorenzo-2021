export default {
  ...
  homepage: {
    ...
    rooms: {
      ...
      rooms: [
        { name: 'serenity', price: '50', text: 'per night' },
        { name: 'harmony', price: '70', text: 'per night' },
        { name: 'freedom', price: '80', text: 'per night' },
        { name: 'joy', price: '60', text: 'per night' },
        { name: 'silence', price: '75', text: 'per night' },
      ],
    },
    activities: {
      title: 'Activities',
