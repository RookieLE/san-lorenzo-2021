...
export default function Room({
  ...
  return (
    <section
      ...
      className="transition hover:bg-gray-100 shadow-xs bg-gray-200/50 rounded-xl transform cursor-pointer py-6 lg:flex lg:justify-center hover:scale-105 group"
    >
      <div className="mx-6 lg:max-w-5xl">
        ...
        <div className="grid max-w-xl py-2 lg:max-w-5xl">
          ...
          <div className="flex place-content-between">
            <button className="px-4 py-2 mt-8 place-content-center flex rounded-lg text-gray-800 transition-colors duration-200 transform bg-gray-200/50 capitalize hover:border-green-800 group-hover:border-green-800 group-hover:bg-green-800 group-hover:text-white hover:bg-green-800 hover:text-white">
              {viewMore}
            </button>
