  ...
  return (
    ...
    >
      <div className="w-full p-2 sm:w-1/2">
        <div className="relative">
          ...
          <input
            ...
            id="name"
            name="name"
            className="w-full rounded px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 shadow-none outline-none appearance-none focus:border-green-700 focus:bg-white focus:ring-2 focus:ring-indigo-200"
          />
      ...
      <div className="w-full p-2">
        <div className="relative">
          ...
          <textarea
            ...
            id="message"
            name="message"
            className="w-full rounded h-32 px-3 py-1 text-base leading-6 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 shadow-none outline-none appearance-none resize-none focus:border-green-700 focus:bg-white focus:ring-2 focus:ring-indigo-200"
          ></textarea>
      ...
      <div className="w-full p-2">
        <input
          type="submit"
          className={`flex px-8 py-2 rounded mx-auto text-lg text-white capitalize border-0 cursor-pointer focus:outline-none ${
